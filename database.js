...
export const SQL = {
	...
	import: async (first_name, last_name, email = '/') => {
		if (!first_name || !last_name)
			throw new Error('[DATABASE ERROR]: Invalid values for names')
		...
		try {
			...
			console.log(
				`User [${first_name} ${last_name}] successfully imported into Database with ID: [${result.insertId}]`,
			)
